...
#  else
        detail::throwResultException( result, "Context::createInstance" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Instance::enumeratePhysicalDevices" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "PhysicalDevice::createDevice" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Device::allocateMemory" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Device::createFence" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Device::createSemaphore" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Device::createEvent" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Device::createQueryPool" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Device::createBuffer" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Device::createBufferView" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Device::createImage" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Device::createImageView" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Device::createPipelineCache" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "PipelineCache::createGraphicsPipelines" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "PipelineCache::createGraphicsPipeline" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "PipelineCache::createComputePipelines" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "PipelineCache::createComputePipeline" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Device::createSampler" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Device::createDescriptorSetLayout" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Device::createDescriptorPool" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Device::allocateDescriptorSets" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Device::createFramebuffer" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Device::createRenderPass" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Device::createCommandPool" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Device::allocateCommandBuffers" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Device::createSamplerYcbcrConversion" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Device::createRenderPass2" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Device::createPrivateDataSlot" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Device::createSwapchainKHR" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "PhysicalDevice::getDisplayPlaneSupportedDisplaysKHR" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "DisplayKHR::createMode" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Instance::createDisplayPlaneSurfaceKHR" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Device::createSharedSwapchainsKHR" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Device::createSharedSwapchainKHR" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Device::registerEventEXT" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Device::registerDisplayEventEXT" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Instance::createDebugUtilsMessengerEXT" );
#  endif
      }
...
#  if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#  else
        detail::throwResultException( result, "Instance::createHeadlessSurfaceEXT" );
#  endif
      }
...
#    if defined( VULKAN_HPP_RAII_NO_EXCEPTIONS )
        return VULKAN_HPP_UNEXPECTED( result );
#    else
        detail::throwResultException( result, "Device::createSemaphoreSciSyncPoolNV" );
#    endif
      }
